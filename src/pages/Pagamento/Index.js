...
function Index() {
  ...
  const handleAddCardSubmit = (event) => {
    ...
    axios.post(`http://127.0.0.1:8080/cards/${userId}`, userCard)
      .then((response) => {
  ...
  const handleDeleteCard = (cardId) => {
    ...
    axios.delete(`http://127.0.0.1:8080/cards/${userId}/${cardId}`)
      .then(response => {
      ...
      <div className="div">
        ...
        {userCards?.map((cards, index) => (
          <div className="div-2Card" key={index}>
            ...
            <div className="text-wrapper-10Card">****-****-****-{typeof cards.number === 'string' ? cards.number.slice(-4) : ''}</div>
                  ...
                  <div className="active-subsBox">
                    <div className="overlap-groupBox">
                      <div className="input-passwordBox">
                        ...
                        <input className="inputBox" value={userCard.number} onChange={(e) => handleInputChange(e, 'number')} alt="NumberCard"/>
                      </div>
                      <div className="text-wrapper-2Box" onClick={handleRemoveCardClick}>x</div>
                    </div>
                    ...
                    <div className="input-password-3Box">
                      ...
                      <input className="inputBox" value={userCard.nameUser} onChange={(e) => handleInputChange(e, 'nameUser')} alt="Nome"/>
                    </div>
                    <div className="input-password-4Box">
                      <div className="text-wrapperBox">Validade</div>
                      <input className="inputBox" value={userCard.expirationDate} onChange={(e) => handleInputChange(e, 'expirationDate')} alt="Validade"/>
                    </div>
                    <div className="button-googleBox">
                      <div onclick={handleRemoveCardClick}><button type="submit" className="confirmarBox" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Confirmar</button></div>
